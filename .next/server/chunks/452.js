...
const MenuDemo = ({ children  })=>{
    ...
    const wizardItems = [
        ...
        {
            label: "Seat",
            command: ()=>router.push("/menu/seat")
        },
        {
            label: "Payment",
            command: ()=>router.push("/menu/payment")
        },
        {
            label: "Confirmation",
            command: ()=>router.push("/menu/confirmation")
        }, 
    ];
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                ...
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    ...
                    children: [
                        ...
                        router.pathname === "/menu" ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
